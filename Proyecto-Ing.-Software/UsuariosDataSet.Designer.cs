...
namespace Proyecto_Ing._Software {
    ...
    public partial class UsuariosDataSet : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsuariosRow AddUsuariosRow(string NombreUsuario, string Contrasena, bool Estado, int IdUsuario) {
...
namespace Proyecto_Ing._Software.UsuariosDataSetTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Usuarios] WHERE (([NombreUsuario] = @Original_NombreUsuario) A" +
                "ND ([Contrasena] = @Original_Contrasena) AND ([Estado] = @Original_Estado) AND (" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuarios] ([NombreUsuario], [Contrasena], [Estado], [IdUsuario" +
                "]) VALUES (@NombreUsuario, @Contrasena, @Estado, @IdUsuario);\r\nSELECT NombreUsua" +
                "rio, Contrasena, Estado, IdUsuario FROM Usuarios WHERE (IdUsuario = @IdUsuario)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Usuarios] SET [NombreUsuario] = @NombreUsuario, [Contrasena] = @Contrasena, [Estado] = @Estado, [IdUsuario] = @IdUsuario WHERE (([NombreUsuario] = @Original_NombreUsuario) AND ([Contrasena] = @Original_Contrasena) AND ([Estado] = @Original_Estado) AND ([IdUsuario] = @Original_IdUsuario));
SELECT NombreUsuario, Contrasena, Estado, IdUsuario FROM Usuarios WHERE (IdUsuario = @IdUsuario)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Proyecto_Ing._Software.Properties.Settings.Default.UsuariosConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT NombreUsuario, Contrasena, Estado, IdUsuario FROM dbo.Usuarios";
        ...
        public virtual int Delete(string Original_NombreUsuario, string Original_Contrasena, bool Original_Estado, int Original_IdUsuario) {
        ...
        public virtual int Insert(string NombreUsuario, string Contrasena, bool Estado, int IdUsuario) {
        ...
        public virtual int Update(string NombreUsuario, string Contrasena, bool Estado, int IdUsuario, string Original_NombreUsuario, string Original_Contrasena, bool Original_Estado, int Original_IdUsuario) {
            if ((NombreUsuario == null)) {
                throw new global::System.ArgumentNullException("NombreUsuario");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string NombreUsuario, string Contrasena, bool Estado, string Original_NombreUsuario, string Original_Contrasena, bool Original_Estado, int Original_IdUsuario) {
            return this.Update(NombreUsuario, Contrasena, Estado, Original_IdUsuario, Original_NombreUsuario, Original_Contrasena, Original_Estado, Original_IdUsuario);
        }
    }
